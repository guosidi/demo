...
class LocalWechat
{
    ...
    public function __construct(){
        ...
        $serverName = isset($_SERVER['SERVER_NAME'])?$_SERVER['SERVER_NAME']:'http://ytest-api-canteen.oomall.com';
   ...
   <sign><![CDATA[%s]]></sign>
    ...
    public function wechatRefund($arrData){
        ...
        $data['total_fee'] = $arrData['total_fee']*100;//订单金额 微信以分为单位
        $data['refund_fee'] = $arrData['total_fee']*100;//订单退款金额 微信以分为单位
        $wechatData = $this->getSign($data);
        /*echo "<pre>";
