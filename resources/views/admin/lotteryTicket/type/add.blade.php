        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase"> 添加彩票</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form class="form-horizontal" id="account-form" action="{{url('lotteryTicket/type/add')}}" method="post">
                        ...
                        <div class="col-md-9">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" width="100%"> </div>
                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
                                <div>
                                    <span class="btn default btn-file">
                                        <span class="fileinput-new">选择图片</span>
                                        <span class="fileinput-exists">修改图片</span>
                                        <input id="pic" type="file" name="pic" accept="image/gif,image/png,image/jpg,image/jpeg" data-rule-required="true" data-msg="请上传商品图">
                                    </span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="name" id="name" placeholder="请输入彩种名称"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea name="summary" id="summary" class="form-control" data-rule-required="true" data-msg="最多输入25个描述文字" placeholder="最多输入25个描述文字" maxlength="25"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="number" class="form-control" name="price" id="price" placeholder="请输入供货价，如：300.00"
                                   maxlength="20" autocomplete="off" data-rule-required="true" data-msg="请输入供货价">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                        ...
                        <div class="col-md-8">
                            <input type="number" class="form-control" name="remain" id="remain" placeholder="输入库存数量，从1到9999的正整数"
                                   autocomplete="off" data-rule-required="true" data-msg="输入库存数量">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="mt-radio-inline">
                                <label class="mt-radio">
                                    <input type="radio" name="status" id="status1" value="1" checked> 上架
                                    <span></span>
                                </label>
                                <label class="mt-radio">
                                    <input type="radio" name="status" id="status0" value="0"> 停售
                                    <span></span>
                                </label>
                            </div>
                        </div>
    ...
    $(function () {
        ...
        var fromValidate = function () {
            ...
            jQuery.validator.addMethod("imgSize", function (value, element) {
                ...
                return this.optional(element)||(maxSize>picSize&&type);
            }, "只支持Jpg、Png、Gif，大小不超过2M");
            theForm.validate({
