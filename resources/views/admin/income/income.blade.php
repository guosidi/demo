            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">订单收入明细</span>
                    </div>
                </div>
                <div class="sxtj">
                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-filter" name="keyword"
                                               id="keyword" placeholder="订单号、商家名称、商家账号" value="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-horizontal" role="form">
                                <div class="form-group">
                                    <div class="col-sm-6" style="text-align: right;">
                                        <a type="button" class="btn btn-primary" id="btn-search">
            ...
            var handle = function () {
                ...
                grid.init({
                    ...
                    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "ajax": {
                            "url": "{{url("income/order")}}" // ajax source
                        },
